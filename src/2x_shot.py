...
emotion_classification_prompt = """Here are few examples of classifying emotions in statements:
...
emotion_classification_chain = emotion_classification | llm
...
emotion_result = emotion_classification_chain.invoke({"question": "That movie was so scary I had to cover my eyes."})
